...
Battlepass XP values are taken from [this tweet](https://twitter.com/Shiick/status/1673766212398903296) and might need to adjusted each season. If i dont do it, just update the `data.json` file.
